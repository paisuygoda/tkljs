...
(function (exports) {
	...
	exports.Window_JobChange = (function() {
		...
		Window_JobChange.prototype.updateJobPosition = function()
		{
			...
			for ( var ii = 0; ii < num; ii++ )
			{
				...
				if (val % 7 === 0 || (val > 14 && val % 7 === 1)) {offsetX += 7; offsetY -= 1;}
				offsetX -= offsetY / 2;
				sprite.setOffset(offsetX * sprite.width * 1.5 , offsetY * sprite.height * 1.6);

				// Show JobLevel
				var jobLevel = this._actor._jobLevel[classId];
				var jobLevelText;
				if (jobLevel === 4) {
					this.drawTextEx('\\i[90]', -17 + offsetX * sprite.width * 1.5, 
						offsetY * sprite.height * 1.6 - 5, 50, 'center');
				} else if (classId === 22) {
					var allMaster = true;
					...
					this.drawText(jobLevelText, -22 + offsetX * sprite.width * 1.5, 
						offsetY * sprite.height * 1.6 - 5, 50, 'center');
				}
			}
		};
	...
	exports.Scene_JobChange = (function() {
		...
		Scene_JobChange.prototype.popScene = function() {
		    if(this._unchanged) SceneManager.pop();
		    else this._dialogWindow.open();
		};
		...
		{
			if (this._unchanged) Scene_MenuBase.prototype.nextActor.call(this);
		};

		Scene_JobChange.prototype.previousActor = function()
		{
			if (this._unchanged) Scene_MenuBase.prototype.previousActor.call(this);
		};
